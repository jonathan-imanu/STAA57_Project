...
subtitle: 'How has the water quality of Ontario’s inland lakes changed from 2015 to 2022, as measured by total phosphorus, calcium, chloride concentration, and water clarity? What does this suggest about the productivity of Ontario’s inland lakes?'
...
This report is based on four datasets all sourced from the Ontario Lake Partner 
...
clarity for numerous inland lakes in the Precambrian Shield region. Each dataset 
includes geospatial information, site descriptions, collection dates, and metrics 
pertaining to the water quality. The data was last validated on January 17, 2024 
and is updated yearly. The largest overlapping period across all four datasets 
