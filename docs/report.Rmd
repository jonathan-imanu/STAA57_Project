...
kable(lake_classification, caption="Average Seechi Disk Depth (m) by Lake Classification")
```
...
From this, it can be determined that the proportion of inland lakes that exhibit eutrophic conditions is estimated to be 0.254, with a 95% confidence interval ranging from 0.225164 and 0.2824012. 
...
kable(quantiles_df, caption="Quantile Results from Bootstrapping")
```
...
<!-- ### Figure 1: Geospatial Plot of Lakes -->

<!-- ```{r, message=FALSE, echo=TRUE, eval=FALSE} -->
<!-- img=readJPEG("ontario.jpg") -->


<!-- ggplot(data, aes(y=Latitude, x=Longitude, col=Site.ID)) +  -->
...
### Table 2: Average Seechi Disk Depth (m) by Lake Classification
...
### Table 3: Quantile Results from Bootstrapping 
